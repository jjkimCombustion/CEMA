...
Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::CEMAChemistryModel
(
...
:
    ...
    (
        ...
        this->mesh_,
        dimensionedScalar("lambda", dimless, 0),
    ...
    (
        ...
        ).lookupOrDefault<label>("nElements", 4)
    )
{
    ...
    Info<< "CEMAChemistryModel: Number of species = " << nSpecie_
...
template<class ReactionThermo, class ThermoType>
Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::
~CEMAChemistryModel()
{}
...
template<class ReactionThermo, class ThermoType>
void Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::omega
(
    const scalarField& c,
    const scalar T,
    const scalar p,
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::omegaI
(
    const label index,
    const scalarField& c,
    const scalar T,
...
template<class ReactionThermo, class ThermoType>
void Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    scalarField& dcdt
...
Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::tc() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::Qdot() const
{
...
Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::calculateRR
(
    const label ri,
    const label si
) const
...
template<class ReactionThermo, class ThermoType>
void Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::CEMAChemistryModel<ReactionThermo, ThermoType>::solve
(
